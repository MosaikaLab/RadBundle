...
class RadControllerGenerator extends RadGeneratorBase {
	...
	public function commit(RadController $controller){
	    ...
	    $abstractClass = (new ClassType("Abstract" . $controller->getName() . "Controller", $abstractNs))
	    ->setAbstract(true)
	    ...
	    foreach($controller->getMethods() as $method){
		    	$nMethod = $abstractClass->addMethod($method->getName());
		    	$nMethod
	    ...
	    $class = (new ClassType($controller->getName() . "Controller", $ns));
